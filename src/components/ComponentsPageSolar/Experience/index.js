...
function Experience() {
    ...
    const [video1Link, setVideo1Link] = useState("https://www.youtube.com/embed/MdxGCto4o68");
    const [video2Link, setVideo2Link] = useState("https://www.youtube.com/embed/QE6rfwwQasE");
    ...
    function resetVideo() {
        ...
        if (video1Link == "") {
            setVideo1Link("https://www.youtube.com/embed/MdxGCto4o68")
            setVideo2Link("")
        } else {
            setVideo2Link("https://www.youtube.com/embed/QE6rfwwQasE")
            setVideo1Link("")
        }
...
mostraram satisfeitas e agradecidas pela concessão das tecnologias.</p>
                ...
                <div className='experience-content'>
                    ...
                    <div className='experience-text'>
                        <div className='experience-text-label'>SERTÃO POTÁVEL – Energia solar</div>
                        <div className='experience-text-txt'>
